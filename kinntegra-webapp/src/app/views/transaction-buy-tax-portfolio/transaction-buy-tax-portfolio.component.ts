...
@Component({
  selector: 'app-transaction-buy-tax-portfolio',
  standalone: true,
  ...
  templateUrl: './transaction-buy-tax-portfolio.component.html',
  styleUrl: './transaction-buy-tax-portfolio.component.scss',
  providers: [
...
export class TransactionBuyTaxPortfolioComponent {
