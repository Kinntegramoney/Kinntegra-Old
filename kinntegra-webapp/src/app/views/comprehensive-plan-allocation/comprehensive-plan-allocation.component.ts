...
@Component({
  selector: 'app-comprehensive-plan-allocation',
  standalone: true,
  ...
  templateUrl: './comprehensive-plan-allocation.component.html',
  styleUrl: './comprehensive-plan-allocation.component.scss'
})
export class ComprehensivePlanAllocationComponent {
  ...
  onNext() {
    if (this.mode == null) {
      this.router.navigate(['comprehensive-plan-cash-flow/' + this.clientId]);
    }
    else {
