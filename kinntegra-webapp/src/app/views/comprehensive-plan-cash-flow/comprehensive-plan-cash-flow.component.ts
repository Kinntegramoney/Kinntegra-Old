...
@Component({
  selector: 'app-comprehensive-plan-cash-flow',
  standalone: true,
  ...
  templateUrl: './comprehensive-plan-cash-flow.component.html',
  styleUrl: './comprehensive-plan-cash-flow.component.scss'
})
export class ComprehensivePlanCashFlowComponent {
  ...
  isBusy!: boolean;
  objParameters = [
    { parameter: 'Annual Savings', amount: '₹10.56K' },
    { parameter: 'Lumpsum ', amount: '₹10.56K' },
    { parameter: 'Total', amount: '₹10.56K' },
  ...
  onNext() {
    if (this.mode == null) {
      this.router.navigate(['comprehensive-plan-recommendation/' + this.clientId]);
    }
    else {
