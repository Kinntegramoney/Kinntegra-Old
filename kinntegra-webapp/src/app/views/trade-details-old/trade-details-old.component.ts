...
@Component({
  selector: 'app-trade-details-old',
  standalone: true,
  ...
  templateUrl: './trade-details-old.component.html',
  styleUrl: './trade-details-old.component.scss',
  providers: [
...
export class TradeDetailsOldComponent implements OnInit, OnChanges {
  ColumnMode = ColumnMode;
  SelectionType = SelectionType;

  clientTransactionId: any;
  clientTransactionPortfolioId: any;
      ...
      if (this.clientTransactionDetails.TransactionPlanCode == 'L') {
        if (this.clientTransactionDetails.TransactionTypeCode === 'B') {
          switch (this.clientTransactionPortfolioType.TransactionPortfolioTypeCode) {
            case 'W':
              this.router.navigate(['transaction/buy/wealth/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
              break;
            case 'T':
              this.router.navigate(['transaction/buy/tax/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
              break;
            case 'ST':
              this.router.navigate(['transaction/buy/shortterm/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
              break;
            case 'G':
              this.router.navigate(['transaction/buy/commodities/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
              break;
            case 'O':
              this.router.navigate(['transaction/buy/other/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
              break;
          }
        }
        else if (this.clientTransactionDetails.TransactionTypeCode === 'S') {
          if (this.clientTransactionDetails.SellCriteria == 'A' || this.clientTransactionDetails.SellCriteria == 'P') {
            ...
            this.router.navigate(['transaction/sell/portfolio/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId])
          }
        }
      }
      else if (this.clientTransactionDetails.TransactionPlanCode == 'SIP') {
        if (this.clientTransactionDetails.TransactionTypeCode === 'B') {
          this.router.navigate(['transaction/buy/sip/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
        }
        ...
        if (this.clientTransactionDetails.TransactionTypeCode === 'S') {
          ...
          this.router.navigate(['transaction/cancel/swp/' + this.clientTransactionId + '/' + this.clientTransactionPortfolioType.ClientTransactionPortfolioTypeId]);
        }
      }
      else if (this.clientTransactionDetails.TransactionPlanCode == 'STP') {
