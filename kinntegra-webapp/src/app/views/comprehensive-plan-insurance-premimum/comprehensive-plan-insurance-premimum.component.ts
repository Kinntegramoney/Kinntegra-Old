...
@Component({
  selector: 'app-comprehensive-plan-insurance-premimum',
  standalone: true,
  ...
  templateUrl: './comprehensive-plan-insurance-premimum.component.html',
  styleUrl: './comprehensive-plan-insurance-premimum.component.scss',
  providers: [ClientService, AppCryptoService, ComprehensivePlanService]
})
export class ComprehensivePlanInsurancePremimumComponent {
  ...
  getClientKycDetails() {
    ...
    this.comprehensivePlanService.GetComprehensivePlanInsurancePremimumExpense(this.clientId).subscribe((cpresult) => {
  ...
  onSave() {
    ...
    let inputData = {
      ...
      ClientInsurancePremimumExpenseDetails: JSON.stringify(ClientIncomeData),

    };
 

    this.comprehensivePlanService.SaveComprehensivePlanInsurancePremimumExpense(inputData).subscribe(
      (result) => {
