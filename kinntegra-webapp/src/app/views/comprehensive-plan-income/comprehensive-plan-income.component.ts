...
@Component({
  selector: 'app-comprehensive-plan-income',
  standalone: true,
  ...
  templateUrl: './comprehensive-plan-income.component.html',
  styleUrl: './comprehensive-plan-income.component.scss',
  providers: [ClientService, AppCryptoService]
})
export class ComprehensivePlanIncomeComponent {
