...
@Component({
  selector: 'app-transaction-buy-short-term-portfolio',
  standalone: true,
  ...
  templateUrl: './transaction-buy-short-term-portfolio.component.html',
  styleUrl: './transaction-buy-short-term-portfolio.component.scss',
  providers: [
...
export class TransactionBuyShortTermPortfolioComponent {
