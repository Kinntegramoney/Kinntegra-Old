...
@Component({
  selector: 'app-comprehensive-plan-household',
  standalone: true,
  ...
  templateUrl: './comprehensive-plan-household.component.html',
  styleUrl: './comprehensive-plan-household.component.scss',
  providers: [ClientService, AppCryptoService, ComprehensivePlanService]
})
export class ComprehensivePlanHouseholdComponent {
  ...
  getClientKycDetails() {
    ...
    this.IncomeCategories = [
      ...
      {
        CategoryName: 'House Rent/Maintenance/Repair',
        IsSelected: false,
        IncomeData: [
          {
            Id: '414E2B5048745659672B513D',
      ...
      {
        CategoryName: 'Conveyance Fuel and Maintenance',
        IsSelected: false,
        IncomeData: [
          {
            Id: '414E2B5048745659672B513D',
      ...
      {
        CategoryName: 'Medicines/Doctor/HealthCare',
        IsSelected: false,
        IncomeData: [
          {
            Id: '414E2B5048745659672B513D',
      ...
      {
        CategoryName: 'Electricity/Water/Labour/AMC',
        IsSelected: false,
        IncomeData: [
          {
            Id: '414E2B5048745659672B513D',
      ...
      {
        CategoryName: 'Mobile/Telephone/Internet',
        IsSelected: false,
        IncomeData: [
          {
            Id: '414E2B5048745659672B513D',
    ...
    this.comprehensivePlanService.GetComprehensivePlanHouseHoldExpense(this.clientId).subscribe((cpresult) => {
      if (cpresult.Status == true) {
        var data = cpresult.Data;
console.log("data",data);
console.log("expese",this.SelectedCategories);
  ...
  onSave() {
    ...
    let inputData = {
      ...
      ClientHouseHoldExpenseDetails: JSON.stringify(ClientIncomeData),

    };
    console.log(inputData);

    this.comprehensivePlanService.SaveComprehensivePlanHouseHoldExpense(inputData).subscribe(
      (result) => {
