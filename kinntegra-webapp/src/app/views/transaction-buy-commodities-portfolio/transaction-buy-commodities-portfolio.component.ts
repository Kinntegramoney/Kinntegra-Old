...
@Component({
  selector: 'app-transaction-buy-commodities-portfolio',
  standalone: true,
  ...
  templateUrl: './transaction-buy-commodities-portfolio.component.html',
  styleUrl: './transaction-buy-commodities-portfolio.component.scss',
  providers: [
...
export class TransactionBuyCommoditiesPortfolioComponent {
