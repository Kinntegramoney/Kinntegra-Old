...
const BSEServiceOld = function () { }

BSEServiceOld.GetPassword = async () => {
    var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetPasswordFileUpload = async () => {
    var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetPasswordOrderEntry = async () => {
    var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetPasswordForChildOrder = async () => {
    var bseConfig = await BSEServiceOld.GetBSEConfig();
    ...
    return new Promise((resolve, reject) => {
        ...
        var headers = { 'Accept': 'application/json', 'Content-type': 'application/json', 'Content-Length': Buffer.byteLength(JSON.stringify(inputData)), 'APIKEY': 'VmxST1UyRkhUbkpOVldNOQ==' };
        const httpAgent = new https.Agent({
            keepAlive: true,
            maxSockets: 100,
            keepAliveMsecs: 1000
...
BSEServiceOld.UploadClientMFD = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();

        var param = await BSEServiceOld.PrepareClientMFDParam(data);
        ...
        return new Promise((resolve, reject) => {
            ...
            var headers = { 'Accept': 'application/json', 'Content-type': 'application/json', 'Content-Length': Buffer.byteLength(JSON.stringify(inputData)) };
            const httpAgent = new https.Agent({
                keepAlive: true,
                maxSockets: 100,
                keepAliveMsecs: 1000
            ...
            var request = https.request(options, function (response) {
                ...
                response.on('end', async () => {
                    ...
                    await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.Id, true), 0, 'Account Creation', result.Status, result.Remarks);

                    if (result.Status == 0) {
                        await BSEServiceOld.UpdateClientAccountStatus(data);
...
BSEServiceOld.PrepareClientMFDParam = async (data) => {
    ...
    // 34  Client Type
    param = param.replace('{34}', BSEServiceOld.GetBseClientTypeCode(process.env.BSE_CLIENT_TYPE));
    // 35  PMS
    ...
    // 68  Div pay mode
    param = param.replace('{68}', BSEServiceOld.GetBseDividendPayModeCode(process.env.BSE_DIVIDEND_PAY_MODE));
    param = param.replace('{81}', BSEServiceOld.GetBseCommunicatioModeCode(process.env.BSE_CLIENT_COMMUNICATION));
...
BSEServiceOld.UploadClientFATCA = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPassword();
        var param = await BSEServiceOld.PrepareClientFATCAParam(data);
            ...
            var request = https.request(options, function (response) {
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.ClientKycProfileId, true), 'FATCA Upload', MFAPIResult[0].toString(), MFAPIResult[1].toString());

                        if (MFAPIResult[0].toString() == "100") {
                            MFAPIResultMessage = MFAPIResult[1];

                            await BSEServiceOld.UpdateClientProfileFATCAStatus(data);
...
BSEServiceOld.PrepareClientFATCAParam = async (data) => {
    //        1   PAN_RP  *
    //        2   PEKRN
    //        3   INV_NAME    *
    //        4   DOB
...
BSEServiceOld.UploadMandateMFD = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPassword();
        var param = await BSEServiceOld.PrepareMandateMFDParam(data);
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        if (MFAPIResult[0].toString() == "100") {
                            ...
                            await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.AccountMandate.Id, true), 'Mandate Upload', MFAPIResult[0].toString(), MFAPIResult[1].toString() + "|" + BSEMandateId);

                            await BSEServiceOld.UpdateClientAccountMandateBSEStatus(data, BSEMandateId);

                            resolve(MFAPIResult[1].toString() + "|" + BSEMandateId);
                        }
                        else {
                            // console.log(param);
                            await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.AccountMandate.Id, true), 'Mandate Upload', MFAPIResult[0].toString(), MFAPIResult[1].toString());
                            resolve(MFAPIResult[1].toString());
                        }
                        // console.log(encryptedPassword);
                    });
...
BSEServiceOld.PrepareMandateMFDParam = async (data) => {
    //        0   CLIENT CODE
    //        1   AMOUNT
    //        2   Mandate Type
    //        3   ACCOUNT NO.
...
BSEServiceOld.UploadClientAOF = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPasswordFileUpload();
            ...
            var request = https.request(options, function (response) {
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), 0, 'AOF Image Upload', UploadFileResult['b:Status'][0].toString(), UploadFileResult['b:ResponseString'][0].toString());

                        if (UploadFileResult['b:Status'][0].toString() == "100") {
                            UploadFileResultMessage = UploadFileResult['b:ResponseString'][0];

                            await BSEServiceOld.UpdateClientAOFImageUploadStatus(data);
...
BSEServiceOld.UploadMandateScanFile = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
            ...
            var request = https.request(options, function (response) {
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.ClientAccountMandateId, true), 'Mandate Image Upload', UploadFileResult['b:Status'][0].toString(), UploadFileResult['b:ResponseString'][0].toString());

                        if (UploadFileResult['b:Status'][0].toString() == "100" && !(UploadFileResult['b:ResponseString'][0].includes('SOME ERROR OCCURED'))) {
                            UploadFileResultMessage = UploadFileResult['b:ResponseString'][0];

                            await BSEServiceOld.UpdateClientMandateImageUploadStatus(data);
...
BSEServiceOld.GetAccessTokenSMFWS = async (requestType) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetMandateStatus = async (req, res, data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();

        var encryptedPassword = await BSEServiceOld.GetAccessTokenSMFWS('MANDATE');
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        if (MandateDetailsResult['b:Status'][0].toString() == "100") {
                            ...
                            await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.Id, true), 'Mandate Status', MandateDetailsResult['b:Status'][0].toString(), MandateDetailsResultMessage);

                            await BSEServiceOld.UpdateClientAccountMandateStatus(data, MandateDetailsResultMessage, MandateDetailsResultRemarks);

                            resolve({ Message: MandateDetailsResultMessage });
                        }
                        else {
                            await BSEServiceOld.CreateBSELog(cryptoEngine.ParamDecrypt(data.ClientAccountId, true), cryptoEngine.ParamDecrypt(data.Id, true), 'Mandate Status', MandateDetailsResult['b:Status'][0].toString(), MandateDetailsResult['b:Message'][0].toString());
...
BSEServiceOld.PushBuyTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPasswordOrderEntry();
        var utn = await BSEServiceOld.GetTempBSEURN();
        ...
        if (data.FolioNumber == '' || data.FolioNumber == 'New Folio') {
            schemeDetails = await BSEServiceOld.GetBSESchemeByISINAmount(data.SchemeName, data.ISIN, data.Amount);
        }
        else {
            schemeDetails = await BSEServiceOld.GetBSESchemeAdditionalByISINAmount(data.SchemeName, data.ISIN, data.Amount);
        }
...
BSEServiceOld.PushXSIPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPasswordOrderEntry();
        var utn = await BSEServiceOld.GetTempBSEURN();
        ...
        schemeDetails = await BSEServiceOld.GetBSESIPSchemeByISINAmountFrequency(data.SchemeName, data.ISIN, data.Amount, data.SIPFrequency);
...
BSEServiceOld.PrepareSWPMFDParam = async (data) => {
    // 1	Client Code
    // 2	Bse Scheme Code
    // 3	Transaction Mode
    // 4	Folio Number
...
BSEServiceOld.PrepareSWPMFDCancelParam = async (data) => {
...
BSEServiceOld.PushSWPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPassword();
        var utn = await BSEServiceOld.GetTempBSEURN();
        ...
        schemeDetails = await BSEServiceOld.GetBSESWPSchemeByISINAmountFrequency(data.SchemeName, data.ISIN, data.SWPInstallmentAmount, data.SWPFrequency);
        ...
        var param = await BSEServiceOld.PrepareSWPMFDParam(data);
...
BSEServiceOld.CancelSWPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPassword();

        var param = await BSEServiceOld.PrepareSWPMFDCancelParam(data);
...
BSEServiceOld.CancelXSIPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetChildOrderDetails = async (data) => {
    try {
        var encryptedPassword = await BSEServiceOld.GetPasswordForChildOrder();
        var bseConfig = await BSEServiceOld.GetBSEConfig();
                ...
                response.on('end', async () => {
                    ...
                    if (result.Status == 100) {
                        ...
                        if (childOrderDetails != null) {
                            ...
                            await BSEServiceOld.UpdateClientTransactionSIPOrder(orderData);
                        }
...
BSEServiceOld.InitiateOTMPayment = async (data) => {
    // console.log(data);
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.InitiateSinglePayment = async (data) => {
    try {
        // console.log(data);
...
BSEServiceOld.InitiateChequeCollectionOrder = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var utn = await BSEServiceOld.GetTempBSEURN();
        var currentDate = new Date();
...
BSEServiceOld.InitiateChequeCollectionGroupId = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.InitiateChequeCollectionDepositChallan = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
...
BSEServiceOld.GetOrderStatus = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
                ...
                response.on('end', async () => {
                    ...
                    if (result.Status == 100) {
                        ...
                        if (orderDetails != null) {
                            ...
                            await BSEServiceOld.UpdateClientTransactionBSEOrderStatus(orderData);
                        }
...
BSEServiceOld.PushSellTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPasswordOrderEntry();
        var utn = await BSEServiceOld.GetTempBSEURN();
        ...
        schemeDetails = await BSEServiceOld.GetBSESchemeRedemptionByISIN(data.SchemeName, data.ISIN);
...
BSEServiceOld.PushSwitchTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPasswordOrderEntry();
        var utn = await BSEServiceOld.GetTempBSEURN();
        ...
        schemeDetailsSwitchFrom = await BSEServiceOld.GetBSESchemeByProductCode(data.ProductCodeSwitchFrom);
        schemeDetailsSwitchTo = await BSEServiceOld.GetBSESchemeByProductCode(data.ProductCodeSwitchTo);
...
BSEServiceOld.PushSTPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var utn = await BSEServiceOld.GetTempBSEURN();
        var schemeDetailsSwitchFrom;
...
BSEServiceOld.CancelSTPTransaction = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var utn = await BSEServiceOld.GetTempBSEURN();
        var schemeDetailsSwitchFrom;
...
BSEServiceOld.ChangePasswordMFD = async (data) => {
    try {
        var bseConfig = await BSEServiceOld.GetBSEConfig();
        var encryptedPassword = await BSEServiceOld.GetPassword();
        var param = await BSEServiceOld.PrepareChangePasswordMFDParam(data);
                ...
                response.on('end', () => {
                    ...
                    parser.parseString(xmlData, async (err, result) => {
                        ...
                        if (MFAPIResult[0].toString() == "100") {
                            ...
                            await BSEServiceOld.UpdateBSELoginPassword(data.NewPassword);
...
BSEServiceOld.PrepareChangePasswordMFDParam = async (data) => {
    //        0   Old Password
    //        1   New Password
    //        2   Conf Password
...
BSEServiceOld.GetBseClientTypeCode = (name) => {
...
BSEServiceOld.GetBseDividendPayModeCode = (name) => {
    switch (name.toLowerCase()) {
        case 'cheque':
            return '01';
        case 'direct credit':
...
BSEServiceOld.GetBseCommunicatioModeCode = (name) => {
    switch (name.toLowerCase()) {
        case 'physical':
            return 'P';
        case 'electronic':
...
BSEServiceOld.GetBSEConfig = async () => {
    var bseConfig = null;
...
BSEServiceOld.UpdateClientAccountStatus = async (data) => {
...
BSEServiceOld.UpdateClientProfileFATCAStatus = async (data) => {
...
BSEServiceOld.UpdateClientAccountMandateBSEStatus = async (data, BSEMandateId) => {
...
BSEServiceOld.UpdateClientAccountMandateStatus = async (data, status, remarks) => {
    var errorMessage = "Error while updating mandate status...";
...
BSEServiceOld.UpdateClientAOFImageUploadStatus = async (data) => {
...
BSEServiceOld.UpdateClientMandateImageUploadStatus = async (data) => {
...
BSEServiceOld.CreateBSELog = async (ClientAccountId, ClientKycProfileId, CommunicationType, BSEStatus, BSERemark) => {
...
BSEServiceOld.GetTempBSEURN = async () => {
    var cnt = 0;
...
BSEServiceOld.GetBSESchemeByISINAmount = async (SchemeName, ISIN, Amount) => {
...
BSEServiceOld.GetBSESchemeAdditionalByISINAmount = async (SchemeName, ISIN, Amount) => {
    var schemeDetails = null;
...
BSEServiceOld.GetBSESIPSchemeByISINAmountFrequency = async (SchemeName, ISIN, Amount, SIPFrequency) => {
    var schemeDetails = null;
...
BSEServiceOld.GetBSESWPSchemeByISINAmountFrequency = async (SchemeName, ISIN, Amount, SWPFrequency) => {
    var schemeDetails = null;
...
BSEServiceOld.GetBSESchemeRedemptionByISIN = async (SchemeName, ISIN) => {
    var schemeDetails = null;
...
BSEServiceOld.GetBSESchemeByProductCode = async (ProductCode) => {
    var schemeDetails = null;
...
BSEServiceOld.UpdateClientTransactionSIPOrder = async (data) => {
...
BSEServiceOld.UpdateClientTransactionBSEOrderStatus = async (data) => {
...
BSEServiceOld.UpdateBSELoginPassword = async (NewPassword) => {
