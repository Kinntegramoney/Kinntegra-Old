...
exports.GetDesignationList = async (req, res) => {
    try {
        ...
        const readResult = await readRequest.execute("GetDesignations");
...
exports.GetDesignationById = async (req, res) => {
    ...
    try {
        ...
        const readResult = await readRequest.execute("GetDesignationById");
        if (readResult.recordset.length > 0) {
...
exports.SaveDesignation = async (req, res) => {
    ...
    var errorMessage = "Error while saving Designation data...";
    ...
    try {
        ...
        if (cryptoEngine.ParamDecrypt(Id, true) == 0) {
            ...
            request.output("Id", msSql.BigInt)
                .input("Name", Name)
                .input("Code", Code)
            const result = await request.execute("InsertDesignation");
        ...
        res.status(200).send({ Status: true, Message: "Designation Saved Successfully.", Data: { Id: Id } });
    }
    catch (err) {
        console.log(err);
        try {
...
exports.DeleteDesignation = async (req, res) => {
    ...
    var errorMessage = "Error while deleting Designation data...";
    ...
    try {
        ...
        request.input("Id", cryptoEngine.ParamDecrypt(Id, true))
        const result = await request.execute("DeleteDesignation");
        await transaction.commit();
        ...
        res.status(200).send({ Status: true, Message: "Designation Deleted Successfully.", Data: {} });
    }
    catch (err) {
        console.log(err);
        try {
